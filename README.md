...
| [`docs/AI_OUTREACH_AGENT.md`](docs/AI_OUTREACH_AGENT.md) | **AI email/voice agent** — auto-contacts phone-only manufacturers for stock/price; cost, compliance, monetization, + the "help distributors upgrade onto us" services arm |
